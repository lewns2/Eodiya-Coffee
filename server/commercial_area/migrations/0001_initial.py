# Generated by Django 3.2.12 on 2022-03-22 10:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seoulgudong', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commercialAreas', to='commercial_area.seoulgudong')),
            ],
        ),
    ]
