# Generated by Django 3.2.12 on 2022-03-28 02:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guCenterXPoint', models.FloatField(null=True)),
                ('guCenterYPoint', models.FloatField(null=True)),
                ('guXYPoint', models.TextField(null=True)),
                ('dongName', models.CharField(max_length=50)),
                ('dongCenterXPoint', models.FloatField(null=True)),
                ('dongCenterYPoint', models.FloatField(null=True)),
                ('dongXYPoint', models.TextField(null=True)),
            ],
        ),
        migrations.CreateModel(
